...
const Shop = () => {
  ...
  return (
    <>
        <div className='shop'>
        {(isFetchingBooks || isFetchingProducts) && <div className="position-absolute top-0 start-0 d-flex align-items-center justify-content-center loader"><div className="spinner-grow bg-transparent"><img src={icon} alt="" /></div></div>}
