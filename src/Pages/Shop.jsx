    ...
    <>
        ...
        {(isFetchingBooks || isFetchingProducts) && <div className="position-absolute top-0 start-0 d-flex align-items-center justify-content-center loader"><div className="spinner-grow"></div></div>}
            <div className="search">
                <div className="search-div w-100 h-100 text-center d-flex flex-column align-items-center justify-content-center gap-5 py-5">
                    <h1 className='text-white my-5'>Find your desired assets</h1>
